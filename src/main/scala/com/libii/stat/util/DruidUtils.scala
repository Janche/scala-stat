...
//    if (dataSource == null) {
//      try {
////        val stream: InputStream = getClass.getClassLoader.getResourceAsStream("druid.properties")
//        var confPath = Thread.currentThread().getContextClassLoader.getResource("druid.properties").getPath
//        confPath = "/root/spark_jar/conf/druid.properties"
