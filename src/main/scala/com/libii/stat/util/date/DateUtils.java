package com.libii.stat.util.date;
...
public class DateUtils {
    ...
    public static void main(String[] args) {
        String yearmonth = StringToString("2021-08-01", DateStyleEnum.YYYY_MM_CN);
    ...
    public static String getYearMonth(Date date) {
        ...
        int month = getInteger(date, Calendar.MONTH) + 1;
     ...
     * @return
     */
    public static String getLastDateInMonth(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        int lastDay = cal.getActualMaximum(Calendar.DAY_OF_MONTH);
        //设置Calendar为指定月份的最后一天
     ...
     * @return
     */
    public static String getFirstTimeInMonth(Date date) {
        return getFirstDateInMonth(date) + " 00:00:00";
    }
     ...
     * @return
     */
    public static String getLastTimeInMonth(Date date) {
        return getLastDateInMonth(date) + " 23:59:59";
    }
    ...
    public static int compareTime(String time1, String time2) {
        Date dateTime1 = DateUtils.StringToDate(time1);
        Date dateTime2 = DateUtils.StringToDate(time2);
